function [output,oligos] = findprobesHD(infile,varargin)
...
% 
%   output = findprobesHD('myinfile.fa',32,'masksequences','maskseqs.fa');
...
%   output = findprobesHD('myinfile.fa',32,'masksequences','maskseqs.fa','nummatchesformask',13);
%
%   Output Arg:
