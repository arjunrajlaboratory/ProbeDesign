function [newMatchVector, whichOligo, matchScore] = selectBestPanOligoFromCandidates_minNumberProbes(prevMatchVector,candidateMatchMatrix,whichOligosAreGoodVector,targetMinNumOligos)
